...
# 파일 경로
excel_path = './../KorA_Valley/KorA_Valley_tracking_2026_02_08.xlsx'  # 수정
output_path = './../KorA_Valley/KorA_Valley_tracking_2026_02_13.xlsx'

# 사람 이름 목록
names = ["천승범", "비씩 20 조예찬형", "신재욱", "서희찬", "윤상민", "최서연", "이연희 Kirsten", "김영준",
         "정성민", "김진호", "유재호님", "황서호형", "박상준님", "홍석채님", "전상우님", "김세현님", "비씩 20 배경덕"]
