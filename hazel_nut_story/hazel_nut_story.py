...
priority_order = [
    ...
    "CS 공부", "운영체제론 공부", "계량경제학 공부", "주채파 공부", "대규모시스템 공부", "기술블로그 읽기", "코딩 공부", "코테 공부", "프로젝트 복습", "프로젝트 정리", "SpringBoot 공부", "JPA 공부", "리액티브 공부", 
    "Redis 공부", "Kafka 공부", "Django 공부", "Nginx 공부", "PostgreSQL 공부", "MySQL 공부", "Docker 공부", "AWS 공부", "GDGoC T19 발표준비", "SURI 공부", "SURI 과제", "퀀트 공부", 
    ...
    "플래너 제작", "코딩 작업", "독후감 작성", "친구글 읽기", "글 읽기", "LinkedIn 수정", "코라밸리 일", "코라밸리 웹개발", "퐅폴 제작", "코라밸리 운영",
    "코라밸리/헬스팸 운영", "지원서 작성", "플래너 작성", "T사 사전과제", "주식스터디 준비", "주식 공부", "인스타 제작", "커피챗 내용정리",
